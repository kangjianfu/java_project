...
public class MenuLogInterceptor implements Interceptor {
	...
	public void intercept(Invocation inv) {
		...
		if (user==null) {
			...
			if(!"/menu/add".equals(inv.getActionKey())){
				String id = inv.getController().getPara("id");
				Menu old_menu = new MenuServiceImpl().findById(id);
				log.set("old_values", JsonKit.toJson(old_menu));
			}
